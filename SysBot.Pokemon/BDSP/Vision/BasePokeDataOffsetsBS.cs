...
public abstract class BasePokeDataOffsetsBS : IPokeDataOffsetsBS
{
    ...
    public abstract IReadOnlyList<long> EggFlagPointer { get; }
    ...
    public abstract IReadOnlyList<long> ItemBlockPointer { get; }
    ...
    public const int ITEM_BLOCK_SIZE_RAM = (0xBB80 / 0x10) * 0xC;
