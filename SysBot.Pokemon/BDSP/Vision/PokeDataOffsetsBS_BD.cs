...
public class PokeDataOffsetsBS_BD : BasePokeDataOffsetsBS
{
    ...
    public override IReadOnlyList<long> R1_SpeciesPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x2A0, 0x2C];
    public override IReadOnlyList<long> R2_SpeciesPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x2A0, 0x4C];
    public override IReadOnlyList<long> R1_SeedPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x2A0, 0x24];
    public override IReadOnlyList<long> R2_SeedPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x2A0, 0x44];
    public override IReadOnlyList<long> EggFlagPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x458];
    public override IReadOnlyList<long> EggSeedPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x460];
    public override IReadOnlyList<long> EggStepPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x468];
    public override IReadOnlyList<long> PartyStartPokemonPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x808, 0x10, 0x20, 0x20, 0x18, 0x20];
    public override IReadOnlyList<long> PartySlot2PokemonPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x808, 0x10, 0x28, 0x20, 0x18, 0x20];
    ...
    public override IReadOnlyList<long> LocationPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x40];
    ...
    public override IReadOnlyList<long> OpponentPokemonPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x800, 0x58, 0x28, 0x10, 0x20, 0x20, 0x18, 0x20];
    public override IReadOnlyList<long> SceneIDPointer { get; } = [0x4C59B50, 0xB8, 0x18];
    public override IReadOnlyList<long> DayTimePointer { get; } = [0x4C59B50, 0xB8, 0x0, 0x60, 0x100];
    ...
    public override IReadOnlyList<long> ItemBlockPointer { get; } = [0x4C64DC0, 0xB8, 0x10, 0x48, 0x20];
}
