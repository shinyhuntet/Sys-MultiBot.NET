...
namespace SysBot.Pokemon
{
	public class AutoRNGSettings
	{
        ...
        [Category(AutoRNG), Description("[AutoCalc] Choose Lead.")]
        public Lead Lead { get; set; } = Lead.None;

        [Category(AutoRNG), Description("Target Species to RNG")]
        public Species TargetSpecies { get; set; } = Species.None;

        [Category(AutoRNG), Description("[AutoCalc] Enter syncNature.")]
        public Nature SyncNature { get; set; } = Nature.Random;

        [Category(AutoRNG), Description("[AutoCalc] Choose GenderRatio.")]
        public GenderRatio GenderRatio { get; set; } = GenderRatio.Genderless;
        
        [Category(AutoRNG), Description("Set value 20, 50, 70")]
        public Compatibility Compatability { get; set; } = Compatibility.Low;
        ...
        [Category(AutoRNG), Description("Do Actions if target become less than this value.")]
        public int DoActionUntil { get; set; } = 600;
