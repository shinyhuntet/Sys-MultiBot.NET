...
public class LairBotSettings : IBotStateSettings, ICountSettings
{
    ...
    private List<LairSpecies> lairSpecies = [];
    ...
    public List<LairSpecies> LairSpeciesQueue { get { if (lairSpecies.Count > 3) lairSpecies = lairSpecies.Slice(0, 3); return lairSpecies; } set { lairSpecies = value; } }
    ...
    [Category(FeatureToggle), Description("Toggle \"True\" to clear penalty count.")]
    public bool ClearPenaltyOnStart { get; set; } = true;
    ...
    [Category(FeatureToggle), Description("Toggle \"True\" to change the Opponent Raid Pokemon Current Hp to 1.")]
    ...
    public class LairScreenValueCategory
    {
        ...
        public string LairAdventurePathValueUSB { get; set; } = "0x000087B8";

        [Category(Lair), Description("Lair Adventure Path (CurrentScreen).")]
        public string LairAdventurePathValueWiFi { get; set; } = "0x0000CAD8";
        ...
        [Category(Lair), Description("Lair OnCatching Screen (MiscScreen).")]
        public string LairOnCatchScreenValue { get; set; } = "0x00000DEE";

        [Category(Lair), Description("Lair Choose Pokemon Screen (MiscScreen).")]
        public string LairChoosePokemonScreenValue { get; set; } = "0x000002FA";
