...
public class PokeDataOffsetsLA
{
    ...
    public IReadOnlyList<long> WildPokemonPtrLA = [0x42A6F00, 0xD0, 0xB8, 0x300, 0x70, 0x60, 0x98, 0x10, 0x00];
    public IReadOnlyList<long> PlayerCoordPtrLA = [0x42D4720, 0x18, 0x48, 0x1F0, 0x18, 0x370, 0x90];
    public IReadOnlyList<long> TimePtrLA = [0x42D4720, 0x18, 0x100, 0x18, 0x28];
