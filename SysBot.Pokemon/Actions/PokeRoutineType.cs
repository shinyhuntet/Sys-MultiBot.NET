...
public enum PokeRoutineType
{
    ...
    /// <summary> Catches Paradox Legendaries until the criteria is satisfied, (optionally) using 100% catch cheat.  </summary>
    EncounterParadox = 7_004,

    /// <summary> Catches Snack Legendaries until the criteria is satisfied, (optionally) using 100% catch cheat.  </summary>
    EncounterSnack = 7_005,

    /// <summary> Retrieves Floette until the criteria is satisfied.  </summary>
    EncounterFloette = 7_006,
